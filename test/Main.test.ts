				...
				classes: [
					{
						...
						name: "SomeClass",
						parent: "",
						attributes: [{ context: "variable", name: "att", type: "number", accessModifyer: "public" }],
						methods: [
							{
								context: "function",
								name: "testing",
				...
				functions: [
					{
						...
						parameters: [{ context: "variable", name: "para1", type: "string" }],
						return: "number",
						async: false,
					},
				],
		...
		test("multiple functions", () => {
			...
			expect(main["context"]).toEqual({
				...
				functions: [
					...
					{ context: "function", name: "another", parameters: [], return: "void", async: false },
				],
				variables: [],
				classes: [],
			});
